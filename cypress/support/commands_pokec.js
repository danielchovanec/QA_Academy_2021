...
Cypress.Commands.add('applicationLogin', (username, password) => {
    ...
    cy.get('.Form-sc-1mfmq26-0 > :nth-child(1) > .Input-sc-1vv8hqf-0').type(username);

    cy.get('.LoginFormstyles__PasswordInputArea-sc-1iebk76-7 > .Input-sc-1vv8hqf-0').type(password);
